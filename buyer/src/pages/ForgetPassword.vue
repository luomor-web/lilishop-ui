  ...
  <div class="forget-password" @click='$refs.verify.show = false'>
    ...
    <div class="foot">
      <Row type="flex" justify="space-around" class="help">
        <a class="item" href="https://7otech.com/" target="_blank">帮助</a>
        <a class="item" href="https://7otech.com/" target="_blank">隐私</a>
        <a class="item" href="https://7otech.com/" target="_blank">条款</a>
      </Row>
      <Row type="flex" justify="center" class="copyright">
        Copyright © {{year}} - Present
        <a href="https://7otech.com/" target="_blank" style="margin: 0 5px"
          >{{config.title}}</a
        >
        版权所有
      </Row>
